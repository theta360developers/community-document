= 360 Media - Unofficial RICOH THETA S Community Guide (Second Guide in Series)
...
* http://theta360developers.github.io/community-document/community.html[360 Media] - Organized community information focused on the most common topics for 360 degree media management
* http://codetricity.github.io/theta-s/index.html[API Guide] - How to use the RICOH THETA S API, a HTTP API based on Open Spherical Camera (OSC) specifications.
Beginners should start here.
* Central site for the four components - planned: code samples, blog, guide
