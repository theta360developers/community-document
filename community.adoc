...
|720x480
|15fps
|USB (not publicly available as of 2/17)
|===
...
* There are a large number of viewers at the [Panotools.org](http://wiki.panotools.org/Panorama_Viewers) site. I've been using [FSPViewer](http://www.fsoft.it/FSPViewer/)
