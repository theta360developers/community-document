...
NOTE: icon:puzzle-piece[] Streaming the THETA V through a Wi-Fi router or mobile hotspot requires the Wireless Live Streaming plug-in, a free download from the THETA Store.

CAUTION: THETA V Ethernet connection
requires a USB OTG Ethernet adapter plugged into the USB port. The THETA V will not charge while using Ethernet. The battery will drain.
...
=== THETA V Streaming with Wi-Fi - icon:puzzle-piece[]
...
=== THETA V Streaming with Ethernet - icon:puzzle-piece[]
...
for more information. Not all USB OTG Ethernet adapters will work. The camera does not charge
while you are connected with Ethernet. It's theoretically possible to 
...
=== THETA V Streaming with a USB Cable
If you are streaming the THETA V over a USB cable, you must select a THETA V video device on your 
Windows or Mac computer when you use an encoding software such as 
https://obsproject.com/[OBS Studio] or https://mpc-hc.org/[MPC-HC] to stream to YouTube
or Facebook.

==== THETA V live streaming OS requirements

* Windows 10 version 1703 or later
* macOS Sierra version 10.12.4 or later.

==== THETA V Windows drivers

* https://theta360.com/en/support/download/liveapp4k/win64[Windows 10 64 bit driver download]
* https://theta360.com/en/support/download/liveapp4k/win32[Windows 10 32 bit driver download]

==== THETA V driver for macOS

The driver is installed automatically when you connect the camera. 
Select RICOH THETA V in OBS or the encoder software you want to use.
...
1. Verify your firmware is 01.82 or above for UVC FullHD
