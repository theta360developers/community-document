...
** http://www.meetup.com/RICOH-THETA-Developers-SF-Bay-Area/[RICOH THETA Developers SF Bay Area Meetup Group]
...
To view a live streaming video with 360 degree navigation, you can upload it to
YouTube. Follow this guide for
https://theta360blog.wordpress.com/2016/04/22/ricoh-theta-s-360-degree-live-streaming-on-youtube/[RICOH THETA 360 degree live streaming on YouTube].
