...
quality is 1920 x 960 with actual size output of 1920  x 960 + 120. THETA V Ethernet connection
...
You can stream the THETA V over Wi-Fi or Ethernet using the 
...
No driver needed. Select RICOH THETA V in OBS or the encoder software you want to use.
